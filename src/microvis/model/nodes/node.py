...
from microvis.model._base import EventedModel, SupportsVisibility
from microvis.model._evented_list import EventedList
from microvis.model.transform import Transform
...
AnyNode = Annotated[
    Union["Image", "Scene", "Points"], Field(discriminator="_node_type")
]
